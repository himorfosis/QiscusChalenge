...
class FictionBookLibrary {
    ...
    public void setBookList(java.util.List<Book> bookList) {
...
class Member {
    // PLACE YOUR CODE HERE
    private String name;
    private java.util.List<Book> borrowBookList = new java.util.ArrayList<>();

    public void borrow(Book book) {

        if (book.getstock() > 0) {
            book.setStock(book.getstock()-1);
            this.getBorrowBook().add(book);
        }
    ...
    public void setBorrowBook(java.util.List<Book> borrowBook) {
        this.borrowBookList = borrowBook;
    }

    public java.util.List<Book> getBorrowBook() {
        return borrowBookList;
    }
}
